...
class PickProfilePic extends StatefulWidget {
  ...
  PickProfilePic({ required this.ArtForms, required this.selectedArtForm }) : super();
...
class _PickProfilePicState extends State<PickProfilePic> {
  ...
  Widget build(BuildContext context) {
    List<String> profilepics = ['https://i.pinimg.com/474x/fd/c4/ea/fdc4ea89768a65c947634967b72fe845.jpg',
      'https://newevolutiondesigns.com/images/wallpapers/cool-4k-wallpaper-9.jpg', 'https://imgs.search.brave.com/otbddk0Y3dateXqMWzum8T3biCXfqGE45FyxpZb2Xms/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9iZXN0/cHJvZmlsZXBpY3R1/cmVzLmNvbS93cC1j/b250ZW50L3VwbG9h/ZHMvMjAyMS8wNC9D/b29sLVBpYy03Nzl4/MTAyNC5qcGc',
      ...
      'https://e0.pxfuel.com/wallpapers/520/288/desktop-wallpaper-samurai-sky-art-thumbnail.jpg', 'https://i.pinimg.com/236x/2f/5d/ce/2f5dce84606a38db3845236528ed3571.jpg',
                          ...
                          child: ClipOval(
                            child: Material(
                              ...
                              child: Ink.image(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    currentUser.defaultImage = profilepics[index];
